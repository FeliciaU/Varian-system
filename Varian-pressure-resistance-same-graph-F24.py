...
filename_res='F24-SmN-In-situ-160928.txt'    #Base name of files that need to be read

#file_location='/home/feliciaullstad/Desktop/Google_Drive/PhD/SmN data/Varian/F24'
file_location='/Users/Felicia/Desktop/Google_Drive/PhD/SmN data/Varian/F24'

Sample_name='F24'
Comment='Pressure_only'
...
ax1.plot(Res_data["Time(s)"],((Res_data["Resistance (Ohm)"])/final_res),'.')
ax1.set_xlabel('Time (s)')
plt.xlim(xmin,xmax)
#plt.ylim(1*10**5,3.5*10**6)
plt.ylim(0.8,1.9)
ax1.set_ylabel('Ratio to start resistance', color='b')
